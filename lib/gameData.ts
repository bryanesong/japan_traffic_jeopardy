import type { GameData, SourceRef } from "./types";
...
// Reusable authoritative sources (verified to resolve as of June 2026).
const SRC = {
  jafRules: {
    label: "JAF — Rules of the Road",
    url: "https://english.jaf.or.jp/driving-in-japan/rules-of-the-road",
  },
  jafTraffic: {
    label: "JAF — Traffic Rules in Japan",
    url: "https://english.jaf.or.jp/driving-in-japan/traffic-rules",
  },
  jafForeign: {
    label: "JAF — Driving with a foreign license",
    url: "https://english.jaf.or.jp/use-jaf-more/drive-in-japan",
  },
  nexcoBike: {
    label: "NEXCO Central — Motorcycle ETC & expressway guide",
    url: "https://www.c-nexco.co.jp/en/inbound-en/etc/etc_guide/bike/",
  },
  npaAlcohol: {
    label: "Japan National Police Agency — Eradication of Drinking and Driving",
    url: "https://www.npa.go.jp/english/bureau/traffic/document/01_EradicationofDrinkingandDriving.pdf",
  },
  oistAlcohol: {
    label: "OIST — Drunk Driving (penalties & joint liability)",
    url: "https://www.oist.jp/resource-center/drunk-driving",
  },
  wikiSigns: {
    label: "Wikipedia — Road signs in Japan",
    url: "https://en.wikipedia.org/wiki/Road_signs_in_Japan",
  },
  liveJapanMoto: {
    label: "LIVE JAPAN — Motorcycle Riding in Japan",
    url: "https://livejapan.com/en/article-a0000201/",
  },
  ninjaLane: {
    label: "The Ninja Rider — Lane Splitting in Japan",
    url: "https://theninjarider.com/lane-splitting-japan/",
  },
  ninjaRules: {
    label: "The Ninja Rider — Motorcycle Laws & Rules for Foreign Riders",
    url: "https://theninjarider.com/motorcycle-rules-japan/",
  },
  thankYou: {
    label: "Top Gear Philippines — How Japanese drivers say 'thank you'",
    url: "https://www.topgear.com.ph/features/feature-articles/japan-thank-you-driving-a00187-20180818",
  },
  ...
  categories: [
    ...
    },
    {
      ...
      clues: [
        {
          value: 200,
          clue: "On every motorcycle in Japan this head-protecting safety item is legally required for BOTH rider and passenger, no matter the engine size.",
    ...
    },
    {
      ...
      clues: [
        ...
        {
          value: 400,
          clue: "Holding one of these handheld devices to talk or look at a screen while riding — unless it's hands-free — costs you a fine and demerit points.",
    ...
    },
    {
      ...
      clues: [
        ...
        {
          value: 400,
          clue: "A round road sign with a BLUE background tells you this is something you are required to do, rather than something prohibited.",
    ...
    },
    {
      ...
      clues: [
        ...
        {
          value: 1000,
          clue: "In town, leaving your bike on the sidewalk risks a fine and towing — so instead seek out one of these dedicated two-wheeler lots, signposted 二輪駐車場.",
